...
#BLOCO DA CAMERA
camFrame = Frame(mGui, width=470, height=430)
camFrame.place(x=100, y=280) #TROCAR LOCAL DO BLOCO
camFrame.config(borderwidth=2, relief="solid")

#BLOCO DA FOTO
infoFrame = Frame(mGui, width=460, height=540, bg='#EEE8E8')
infoFrame.place(x=1000, y=250) #TROCAR LOCAL DO BLOCO
...
v2 = Label(mGui, text=almoco, width=53, background='#EEE8E8', foreground='black', font=('Arial', 30, 'bold')) 
v2.place(x=140, y=150) #TROCAR LOCAL DO BLOCO
